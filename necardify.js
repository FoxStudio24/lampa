(function () {
  ...
  function startPlugin() {
    ...
    Follow.get(Type.de([102, 117, 108, 108]), function (e) {
      if (Type.co(e)) {
        console.log('Cardify: Ð¡Ð¾Ð±Ñ‹Ñ‚Ð¸Ðµ complete, Ð¾Ð±Ñ€Ð°Ð±Ð¾Ñ‚ÐºÐ° Ð´Ð°Ð½Ð½Ñ‹Ñ…...');
        Follow.skodf(e);
        if (!Main.cases()[Main.stor()].field('cardify_run_trailers')) {
          console.log('Cardify: ÐŸÐ¾ÐºÐ°Ð· Ñ‚Ñ€ÐµÐ¹Ð»ÐµÑ€Ð¾Ð² Ð¾Ñ‚ÐºÐ»ÑŽÑ‡ÐµÐ½ Ð² Ð½Ð°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ°Ñ…');
          return;
        }
