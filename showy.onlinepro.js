  ...
  function component(object) {
    ...
    this.noConnectToServer = function (er) {
      ...
      html.find(".online-empty__time").text(
        er && er.accsdb ? er.msg : Lampa.Lang.translate("lampac_does_not_answer_text").replace("{balanser}", sources[balanser].name)
      );
      scroll.clear();
      scroll.append(html);
      this.loading(false);
  ...
  function startPlugin() {
    ...
    Lampa.Lang.add({
      ...
      lampac_balanser_timeout: {
        ...
        zh: "均衡器将在<span class='timeout'>10</span>秒内自动切换。",
      },
